...
public class Fingerprint {
    ...
    public static int[] applyRotation(int[] minutia, int centerRow, int centerCol, int rotation) {
        ...
        int cos = (int) Math.round(Math.cos(Math.toRadians(rotation)));
        int sin = (int) Math.round(Math.sin(Math.toRadians(rotation)));
        int newX = x * cos - y * sin;
        int newY = x * sin + y * cos;
    ...
    public static int matchingMinutiaeCount(List<int[]> minutiae1, List<int[]> minutiae2, int maxDistance,
        ...
        for (int[] minutia1 : minutiae1) {
            for (int[] minutia2 : minutiae2) {
                int euclideanDistance = (int) Math.sqrt(Math.pow(minutia1[0] - minutia2[0], 2) + Math.pow(minutia1[1] - minutia2[1], 2));
